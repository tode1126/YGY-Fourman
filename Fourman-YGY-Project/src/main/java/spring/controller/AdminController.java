...
public class AdminController {
	...
	public String userMultiDisable(HttpServletRequest request, @RequestParam(defaultValue = "1") String pageNum , @PathVariable("pageName") String pageName) {
		HttpSession session = request.getSession();
		LoginDto dto = (LoginDto) session.getAttribute("userLoginInfo");
	...
	public String userMultiEnable(HttpServletRequest request, @RequestParam(defaultValue = "1") String pageNum, @PathVariable("pageName") String pageName) {
		HttpSession session = request.getSession();
		LoginDto dto = (LoginDto) session.getAttribute("userLoginInfo");
		String[] targetEmails=request.getParameterValues("multipleAction");
	...
	public ModelAndView searchUser(@RequestParam(value = "pageNum", defaultValue = "1") int currentPage,@RequestParam(defaultValue="1") String targetEmail) {
		ModelAndView model = new ModelAndView();
	...
	public ModelAndView searchFoodUserCount(@RequestParam(value = "pageNum", defaultValue = "1") int currentPage,@RequestParam(defaultValue="1") String targetEmail) {
		ModelAndView model = new ModelAndView();
		UserSearchDto USDto = new UserSearchDto();
	...
	public ModelAndView searchLeaveFoodUser(@RequestParam(value = "pageNum", defaultValue = "1") int currentPage,@RequestParam(defaultValue="1") String targetEmail) {
		ModelAndView model = new ModelAndView();
		UserSearchDto USDto = new UserSearchDto();
	...
	public ModelAndView searchLeaveUser(@RequestParam(value = "pageNum", defaultValue = "1") int currentPage,@RequestParam(defaultValue="1") String targetEmail) {
		ModelAndView model = new ModelAndView();
		UserSearchDto USDto = new UserSearchDto();
